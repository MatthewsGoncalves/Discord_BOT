...
module.exports = {
  ...
  Token: process.env.TOKEN_BOT, //Discord Bot Token
  ...
  Presence: {
    ...
    name: "the team die", // The message shown
  ...
  Spotify: {
    ClientID: process.env.SPOTFY_CLIENTID, //Spotify Client ID
    ClientSecret: process.env.SPOTFY_CLIENTSECRET, //Spotify Client Secret
  },
};
